...
6. Почти все шаблоны словаря намеренно включают начало слова. Ни одна словоформа не обрабатывается двумя шаблонами (кроме исключений в виде regex и нескольких шаблонов с кавычками), проверка на двойные срабатывания производится дял каждой версии и предполагается, что ошибки этого типа исключены.
...
1. Ё-фикация в процессе: обработано примерно 165 тыс. из всего 230 тыс. словоформ. Конфликты с шаблонами тех же словоформ без ё устранены.

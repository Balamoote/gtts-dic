...
regex"(?i)(?<!\b[гм]|зел[её]но|\bиз|\bкак|\bкое|\bкрасно|\bсветло|\bсеро|\bт[её]мно|\bяйце|[0-9IVXХCСL]{1,20})-(?!то\b|таки|временн|образн|[ст]воему\b|моему\b)"=" "
...
6. Принциально существует возможность для текстов с предварительно расставленными ударениями вывести нужные слова из-под действия TTSLexx, чтобы избежать ситуации с несколькими ударениями в одном слове. А именно, нужно перед словом поставить 2 символа: <служебный символ><символ ударения>. Например, у нас есть слово тексте с проставленным ударением "проходи́мец" и шаблон " проходи"=" прохо́ди", что на выходе даст: прохо́ди́мец и произношение про́ходимец (2 ударения означают "никакого ударения"). Если же записать слово так: °́проходи́мец (<служебный символ "градус" (как вариант: -)>знак ударения U0301> то шаблоны словаря не сработают и слово с ударением будет прочтено, так, как в тексте.

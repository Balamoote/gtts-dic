...
2. полностью деёфицировать текст (те же пару минут работы в соответствующем текстовом редакторе) и полагаться только на работу данного словаря, однако некорые омографы могут произноситься неверно. Однако, если принять меры для сохранения ё в словах типа "всё", то это будет, возможно, самый оптимальный вариант.

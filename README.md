...
Особенности:
1. в настройках TTSLexx выключить опцию "замена еЕ на ёЁ". Словарь сделан и тестировался только с выключенной опцией. После полной ё-фикации словаря, возможно, положение этого переключателя не будет иметь значения.
...
1. Ё-фикация в процессе: обработано примерно 165 тыс. из всего 230 тыс. словоформ. Временно возможны конфликты шаблонов с "ё" с уже имеющимися - они устраняются в рабочем порядке.
